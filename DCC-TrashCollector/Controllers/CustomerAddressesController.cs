...
namespace DCC_TrashCollector.Controllers
{
    public class CustomerAddressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerAddressId,AddressLine,City,Zip,State")] CustomerAddress customerAddress)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerAddressId,AddressLine,City,Zip,State")] CustomerAddress customerAddress)
        {
            if (ModelState.IsValid)
            {
