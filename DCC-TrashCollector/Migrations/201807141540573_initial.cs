                ...
                c => new
                    {
                        ...
                        CustomerScheduleId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.CustomerId)
                .ForeignKey("dbo.CustomerAddresses", t => t.CustomerAddressId, cascadeDelete: true)
                .ForeignKey("dbo.CustomerSchedules", t => t.CustomerScheduleId, cascadeDelete: true)
                .Index(t => t.CustomerAddressId)
                .Index(t => t.CustomerScheduleId);
                ...
                c => new
                    {
                        ...
                        RegPickupDate = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        AssignZipCode = c.Int(nullable: false),
